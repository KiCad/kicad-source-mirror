...
class AllegroBrd(KaitaiStruct):
    ...
    class Type37(KaitaiStruct):
        SEQ_FIELDS = ["t", "t2", "key", "ptr1", "un2", "capacity", "count", "un3", "ptrs", "un4"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type32PlacedPad(KaitaiStruct):
        ...
        def _read(self):
            ...
            self._debug['ptr7']['start'] = self._io.pos()
            self.ptr7 = self._io.read_u4le()
            self._debug['ptr7']['end'] = self._io.pos()
            self._debug['ptr8']['start'] = self._io.pos()
            self.ptr8 = self._io.read_u4le()
            self._debug['ptr8']['end'] = self._io.pos()
            self._debug['previous']['start'] = self._io.pos()
            self.previous = self._io.read_u4le()
            self._debug['previous']['end'] = self._io.pos()
            if self._root.ver >= 1311744:
                self._debug['un2']['start'] = self._io.pos()
                self.un2 = self._io.read_u4le()
                self._debug['un2']['end'] = self._io.pos()

            self._debug['ptr10']['start'] = self._io.pos()
            self.ptr10 = self._io.read_u4le()
            self._debug['ptr10']['end'] = self._io.pos()
    ...
    class Type08(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "ptr1", "str_ptr_16x", "ptr2", "str_ptr", "ptr3", "un1", "ptr4"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type06(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "next", "ptr_str", "ptr_2", "ptr_instance", "ptr_fp", "ptr_x08", "ptr_x03_symbol", "unk"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            ...
            self.next = self._io.read_u4le()
            self._debug['next']['end'] = self._io.pos()
            self._debug['ptr_str']['start'] = self._io.pos()
            self.ptr_str = self._io.read_u4le()
            self._debug['ptr_str']['end'] = self._io.pos()
    ...
    class Type30StrWrapper(KaitaiStruct):
        ...
        class TextAligmnent(Enum):
            ...
            right = 2
            center = 3
        SEQ_FIELDS = ["type", "layer", "key", "next", "un4", "un5", "font", "ptr3", "un7", "str_graphic_ptr", "un1", "font_16x", "ptr4", "coords", "un3", "rotation", "ptr3_16x"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            ...
            if self._root.ver >= 1313024:
                self._debug['un7']['start'] = self._io.pos()
                self.un7 = self._io.read_u4le()
                self._debug['un7']['end'] = self._io.pos()
    ...
    class Type3c(KaitaiStruct):
        SEQ_FIELDS = ["t", "t2", "key", "un", "num_entries", "entries"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type2b(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "fp_str_ref", "_unnamed4", "corrds", "next", "ptr2", "ptr3", "ptr4", "ptr5", "str_ptr1", "ptr6", "ptr7", "ptr8", "un2", "un3"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            ...
            self._debug['corrds']['start'] = self._io.pos()
            self.corrds = []
            for i in range(4):
                if not 'arr' in self._debug['corrds']:
                    self._debug['corrds']['arr'] = []
                self._debug['corrds']['arr'].append({'start': self._io.pos()})
                self.corrds.append(self._io.read_u4le())
                self._debug['corrds']['arr'][i]['end'] = self._io.pos()

            self._debug['corrds']['end'] = self._io.pos()
            self._debug['next']['start'] = self._io.pos()
            self.next = self._io.read_u4le()
            self._debug['next']['end'] = self._io.pos()
            self._debug['ptr2']['start'] = self._io.pos()
            ...
            self._debug['str_ptr1']['start'] = self._io.pos()
            self.str_ptr1 = self._io.read_u4le()
            self._debug['str_ptr1']['end'] = self._io.pos()
            self._debug['ptr6']['start'] = self._io.pos()
            self.ptr6 = self._io.read_u4le()
            self._debug['ptr6']['end'] = self._io.pos()
            self._debug['ptr7']['start'] = self._io.pos()
    ...
    class Type33Via(KaitaiStruct):
        SEQ_FIELDS = ["t", "layer", "key", "un1", "net_ptr", "un2", "un4", "ptr2", "ptr7", "coords", "ptr3", "ptr4", "ptr5", "ptr6", "un3", "bb_coords"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            ...
            self.un3 = []
            for i in range(2):
                if not 'arr' in self._debug['un3']:
                    self._debug['un3']['arr'] = []
                self._debug['un3']['arr'].append({'start': self._io.pos()})
                self.un3.append(self._io.read_u4le())
                self._debug['un3']['arr'][i]['end'] = self._io.pos()
    ...
    class Type14(KaitaiStruct):
        SEQ_FIELDS = ["type", "layer", "key", "next", "ptr1", "un2", "un3", "ptr2", "ptr3", "ptr4"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class LayerInfo(KaitaiStruct):
        ...
        class LayerFamily(Enum):
            board_geometry = 1
            copper = 6
            silk = 9
        SEQ_FIELDS = ["family", "ordinal"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            self._debug['family']['start'] = self._io.pos()
            self.family = KaitaiStream.resolve_enum(AllegroBrd.LayerInfo.LayerFamily, self._io.read_u1())
            self._debug['family']['end'] = self._io.pos()
            self._debug['ordinal']['start'] = self._io.pos()
            self.ordinal = self._io.read_u1()
            self._debug['ordinal']['end'] = self._io.pos()
    ...
    class Type31Sgraphic(KaitaiStruct):
        ...
        class StringLayer(Enum):
            ...
            bot_refdes = 64013
            top_refdes = 64269
        SEQ_FIELDS = ["t", "layer", "key", "str_graphic_wrapper_ptr", "coords", "un", "len", "un2", "value"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            ...
            self._debug['t']['end'] = self._io.pos()
            self._debug['layer']['start'] = self._io.pos()
            self.layer = KaitaiStream.resolve_enum(AllegroBrd.Type31Sgraphic.StringLayer, self._io.read_u2le())
            self._debug['layer']['end'] = self._io.pos()
            self._debug['key']['start'] = self._io.pos()
            self.key = self._io.read_u4le()
            self._debug['key']['end'] = self._io.pos()
    ...
    class Type23Ratline(KaitaiStruct):
        SEQ_FIELDS = ["type", "layer", "key", "next", "flags", "ptr1", "ptr2", "ptr3", "coords", "un", "un2", "un1"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type2e(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "un", "un1"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type10(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "_unnamed3", "ptr1", "_unnamed5", "ptr2", "un1", "ptr3", "ptr4", "path_str"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type0c(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "next", "_unnamed4", "_unnamed5", "_unnamed6", "_unnamed7", "keyind", "_unnamed9", "coords", "_unnamed11", "_unnamed12"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            ...
            self._debug['_unnamed7']['end'] = self._io.pos()
            self._debug['keyind']['start'] = self._io.pos()
            self.keyind = self._io.read_u4le()
            self._debug['keyind']['end'] = self._io.pos()
    ...
    class Type01Arc(KaitaiStruct):
        SEQ_FIELDS = ["t", "un0", "subtype", "key", "next", "parent", "un1", "un6", "width", "coords", "x", "y", "r", "bbox"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type38Film(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "next", "layer_list", "film_name", "layer_name_str", "un2", "un1", "un3"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type15Segment(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "next", "parent", "un3", "un4", "width", "coords"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class BoardObject(KaitaiStruct):
        ...
        def _read(self):
            ...
            if _on == 14:
                ...
                self.data = AllegroBrd.Type17Segment(self._io, self, self._root)
            elif _on == 48:
                ...
                self.data = AllegroBrd.Type16Segment(self._io, self, self._root)
            elif _on == 30:
    ...
    class Type11(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "ptr1", "ptr2", "ptr3", "_unnamed6", "_unnamed7"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type03(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "next", "un1", "subtype", "unhdr", "size", "un2", "data"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            ...
            self.subtype = self._io.read_u1()
            self._debug['subtype']['end'] = self._io.pos()
            self._debug['unhdr']['start'] = self._io.pos()
            self.unhdr = self._io.read_u1()
            self._debug['unhdr']['end'] = self._io.pos()
            self._debug['size']['start'] = self._io.pos()
    ...
    class Type17Segment(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "next", "parent", "_unnamed5", "_unnamed6", "width", "coords"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type36(KaitaiStruct):
        ...
        class X08(KaitaiStruct):
            SEQ_FIELDS = ["a", "b", "char_height", "char_width", "un2", "xs", "ys"]
            def __init__(self, _io, _parent=None, _root=None):
                self._io = _io
                self._parent = _parent
                self._root = _root if _root else self
    ...
    class Type2d(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "next", "un4", "inst_ref_16x", "_unnamed6", "_unnamed7", "_unnamed8", "flags", "rotation", "coord_x", "coord_y", "inst_ref", "ptr1", "first_pad_ptr", "ptr3", "ptr4"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            ...
            self.ptr4 = []
            for i in range(4):
                if not 'arr' in self._debug['ptr4']:
                    self._debug['ptr4']['arr'] = []
                self._debug['ptr4']['arr'].append({'start': self._io.pos()})
                self.ptr4.append(self._io.read_u4le())
                self._debug['ptr4']['arr'][i]['end'] = self._io.pos()
    ...
    class Type16Segment(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "next", "parent", "flags", "_unnamed6", "width", "coords"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type04NetAssignment(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "next", "ptr1", "ptr2", "_unnamed6"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type24Rect(KaitaiStruct):
        SEQ_FIELDS = ["t", "layer", "key", "next", "ptr1", "un1", "un2", "coords", "ptr2", "un"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type05Track(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "_unnamed3", "ptr0", "ptr1", "_unnamed6", "ptr2", "_unnamed8", "ptr3a", "ptr3b", "_unnamed11", "first_segment_ptr", "ptr5", "_unnamed14"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
        ...
        def _read(self):
            ...
            for i in range(2):
                if not 'arr' in self._debug['_unnamed6']:
                    self._debug['_unnamed6']['arr'] = []
                self._debug['_unnamed6']['arr'].append({'start': self._io.pos()})
                self._unnamed6.append(self._io.read_u4le())
                self._debug['_unnamed6']['arr'][i]['end'] = self._io.pos()
            ...
            self.ptr2 = []
            for i in range(2):
                if not 'arr' in self._debug['ptr2']:
                    self._debug['ptr2']['arr'] = []
                self._debug['ptr2']['arr'].append({'start': self._io.pos()})
                self.ptr2.append(self._io.read_u4le())
                self._debug['ptr2']['arr'][i]['end'] = self._io.pos()
    ...
    class Type12(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "ptr1", "ptr2", "ptr3", "un0", "un1", "un2"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
    ...
    class Type2cTable(KaitaiStruct):
        SEQ_FIELDS = ["_unnamed0", "_unnamed1", "key", "next", "_unnamed4", "string_ptr", "_unnamed6", "ptr1", "ptr2", "ptr3", "flags"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
            ...
            if self._root.ver >= 1311744:
                ...
                for i in range(3):
                    if not 'arr' in self._debug['_unnamed4']:
                        self._debug['_unnamed4']['arr'] = []
                    self._debug['_unnamed4']['arr'].append({'start': self._io.pos()})
                    self._unnamed4.append(self._io.read_u4le())
                    self._debug['_unnamed4']['arr'][i]['end'] = self._io.pos()

                self._debug['_unnamed4']['end'] = self._io.pos()

            self._debug['string_ptr']['start'] = self._io.pos()
            self.string_ptr = self._io.read_u4le()
            self._debug['string_ptr']['end'] = self._io.pos()
            if self._root.ver < 1311744:
                self._debug['_unnamed6']['start'] = self._io.pos()
                self._unnamed6 = self._io.read_u4le()
                self._debug['_unnamed6']['end'] = self._io.pos()
    ...
    class Type28Shape(KaitaiStruct):
        SEQ_FIELDS = ["type", "layer", "key", "next", "ptr1", "un2", "un5", "ptr2", "ptr3", "ptr4", "first_segment_ptr", "un3", "un4", "ptr7", "ptr6", "ptr7_16x", "coords"]
        def __init__(self, _io, _parent=None, _root=None):
            self._io = _io
            self._parent = _parent
            self._root = _root if _root else self
