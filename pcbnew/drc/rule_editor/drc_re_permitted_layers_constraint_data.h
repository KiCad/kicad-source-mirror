...
public:
    ...
    std::vector<DRC_RE_FIELD_POSITION> GetFieldPositions() const override
    {
        ...
        return {
            { 150, 365, 52, _( "Allow top Layer" ), LABEL_POSITION::RIGHT,
              _( "Allow matched items on the front copper layer" ) }, // top layer checkbox (upper left)
            { 150, 365, 212, _( "Allow bottom Layer" ), LABEL_POSITION::RIGHT,
              _( "Allow matched items on the back copper layer" ) }, // bot layer checkbox (lower left)
        };
    }
