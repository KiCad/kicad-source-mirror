...
DRC_RE_ABSOLUTE_LENGTH_TWO_PANEL_BASE::DRC_RE_ABSOLUTE_LENGTH_TWO_PANEL_BASE( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	m_staticText1 = new wxStaticText( this, wxID_ANY, _("Minimum Length"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText3 = new wxStaticText( this, wxID_ANY, _("Optimum Length"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText3->Wrap( -1 );
	fgSizer3->Add( m_staticText3, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

	m_textOptimumLength = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( -1,-1 ), 0 );
	fgSizer3->Add( m_textOptimumLength, 0, wxALL|wxEXPAND|wxRIGHT, 5 );
	...
	m_staticText5 = new wxStaticText( this, wxID_ANY, _("Maximum Length"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText5->Wrap( -1 );
	fgSizer3->Add( m_staticText5, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );

	m_textMaximumLength = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( -1,-1 ), 0 );
	fgSizer3->Add( m_textMaximumLength, 0, wxALL|wxEXPAND|wxRIGHT, 5 );

	m_staticText6 = new wxStaticText( this, wxID_ANY, _("mm"), wxDefaultPosition, wxDefaultSize, 0 );
