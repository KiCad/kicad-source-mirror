...
class DRC_RE_ROUTING_WIDTH_PANEL : public DRC_RE_ROUTING_WIDTH_PANEL_BASE,
                                   public DRC_RULE_EDITOR_CONTENT_PANEL_BASE
{
public:
    DRC_RE_ROUTING_WIDTH_PANEL( wxWindow* aParent, wxString* aConstraintTitle,
...
private:
    std::shared_ptr<DRC_RE_ROUTING_WIDTH_CONSTRAINT_DATA> m_constraintData;
};
