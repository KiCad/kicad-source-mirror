...
class DRC_RE_ROUTING_DIFF_PAIR_PANEL : public DRC_RE_ROUTING_DIFF_PAIR_PANEL_BASE,
                                       public DRC_RULE_EDITOR_CONTENT_PANEL_BASE
{
public:
    DRC_RE_ROUTING_DIFF_PAIR_PANEL( wxWindow* aParent, wxString* aConstraintTitle,
