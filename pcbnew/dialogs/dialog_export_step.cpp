...
protected:
    ...
    {
        return DoubleValueFromString( EDA_UNITS_T::UNSCALED_UNITS, m_STEP_Xorg->GetValue() );
    }

    double GetYOrg()
    {
        return DoubleValueFromString( EDA_UNITS_T::UNSCALED_UNITS, m_STEP_Yorg->GetValue() );
    }
