...
DIALOG_BOARD_STATISTICS_BASE::DIALOG_BOARD_STATISTICS_BASE( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : DIALOG_SHIM( parent, id, title, pos, size, style )
{
	...
	componentsLabel = new wxStaticText( this, wxID_ANY, wxT("Components"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_gridComponents->SetGridLineColour( wxSystemSettings::GetColour( wxSYS_COLOUR_BTNSHADOW ) );
	...
	m_gridComponents->SetDefaultCellAlignment( wxALIGN_CENTRE, wxALIGN_TOP );
	...
	padsLabel = new wxStaticText( this, wxID_ANY, wxT("Pads"), wxDefaultPosition, wxDefaultSize, 0 );
	padsLabel->Wrap( -1 );
	bSizer3->Add( padsLabel, 0, wxALL, 5 );
	...
	m_gridPads->SetGridLineColour( wxSystemSettings::GetColour( wxSYS_COLOUR_BTNSHADOW ) );
	...
	m_gridPads->SetDefaultCellAlignment( wxALIGN_CENTRE, wxALIGN_TOP );
	m_gridPads->SetMaxSize( wxSize( -1,300 ) );
	
	bSizer3->Add( m_gridPads, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	
	
	gbContentsSizer->Add( bSizer3, wxGBPosition( 0, 1 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	
	wxBoxSizer* bSizer5;
	bSizer5 = new wxBoxSizer( wxVERTICAL );
	
	wxStaticText* boardLabel;
	boardLabel = new wxStaticText( this, wxID_ANY, wxT("Board Size"), wxDefaultPosition, wxDefaultSize, 0 );
	boardLabel->Wrap( -1 );
	bSizer5->Add( boardLabel, 0, wxALL, 5 );
	...
	m_gridBoard->SetGridLineColour( wxSystemSettings::GetColour( wxSYS_COLOUR_BTNSHADOW ) );
	...
	m_gridBoard->SetDefaultCellAlignment( wxALIGN_CENTRE, wxALIGN_TOP );
	m_gridBoard->SetMaxSize( wxSize( -1,300 ) );
	
	bSizer5->Add( m_gridBoard, 0, wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	
	
	gbContentsSizer->Add( bSizer5, wxGBPosition( 1, 1 ), wxGBSpan( 1, 1 ), wxEXPAND, 5 );
	...
	bMainBoxSizer->Add( gbContentsSizer, 1, wxALIGN_CENTER_HORIZONTAL|wxBOTTOM|wxEXPAND|wxLEFT|wxRIGHT|wxTOP, 10 );
	...
	m_checkBoxSubtractHoles = new wxCheckBox( this, wxID_ANY, wxT("Subtract holes from board area"), wxDefaultPosition, wxDefaultSize, 0 );
	gOptionsSizer->Add( m_checkBoxSubtractHoles, 0, wxALL|wxEXPAND, 5 );
	
	m_checkBoxExcludeComponentsNoPins = new wxCheckBox( this, wxID_ANY, wxT("Exclude components with no pins"), wxDefaultPosition, wxDefaultSize, 0 );
