///////////////////////////////////////////////////////////////////////////
// C++ code generated with wxFormBuilder (version Apr  1 2016)
...
DialogEditModuleText_base::DialogEditModuleText_base( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : DIALOG_SHIM( parent, id, title, pos, size, style )
{
	...
	bSizer10->Add( fgSizer1, 1, wxALIGN_CENTER_VERTICAL|wxALL|wxEXPAND, 5 );
	...
	fgSizer2->Add( m_Show, 1, wxEXPAND|wxRIGHT, 5 );
	...
	fgSizer2->Add( m_Style, 1, wxEXPAND|wxLEFT, 5 );


	fgSizer3->Add( fgSizer2, 1, wxALL|wxEXPAND, 5 );
	...
	fgSizer3->Add( m_Orient, 1, wxALL|wxEXPAND, 5 );
	...
	fgSizer3->Add( m_staticTextRotation, 0, wxEXPAND, 5 );

	m_OrientValue = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer3->Add( m_OrientValue, 0, wxEXPAND, 5 );


	bSizer10->Add( fgSizer3, 0, wxALL|wxEXPAND, 5 );
