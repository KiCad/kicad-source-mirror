 ...
 */
 ...
 public:
    ...
    // Compute aggregate extra length/delay for other nets sharing the same signal as the two
    // provided nets (if both belong to the same non-empty signal). Returns true if aggregation
