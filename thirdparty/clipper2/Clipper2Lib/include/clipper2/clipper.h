...
namespace Clipper2Lib {
  ...
  inline PathsD ClipRectLines(const RectD& rect, const PathD& line, int precision = 2)
  {
    PathsD tmp;
    tmp.push_back(line);
    return ClipRect(rect, tmp, precision);
  }
