...
// ClipRect & ClipRectLines:
EXTERN_DLL_EXPORT CPaths64 ClipRect64(const CRect64& rect,
  const CPaths64 paths, bool convex_only = false);
EXTERN_DLL_EXPORT CPathsD ClipRectD(const CRectD& rect,
  const CPathsD paths, int precision = 2, bool convex_only = false);
EXTERN_DLL_EXPORT CPaths64 ClipRectLines64(const CRect64& rect,
  const CPaths64 paths);
EXTERN_DLL_EXPORT CPathsD ClipRectLinesD(const CRectD& rect,
