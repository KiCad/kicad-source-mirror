...
namespace Clipper2Lib {
  ...
  OutPt2* ClipRect_::Add(Point64 pt, bool start_new)
  {
  ...
  void ClipRect_::AddCorner(Location prev, Location curr)
  {
  ...
  void ClipRect_::AddCorner(Location& loc, bool isClockwise)
  {
    if (isClockwise)
    {
  ...
  void ClipRect_::GetNextLocation(const Path64& path,
  ...
  void ClipRect_::ExecuteInternal(const Path64& path)
  {
  ...
  void ClipRect_::TidyEdges(int idx, OutPt2List& cw, OutPt2List& ccw)
  {
    if (ccw.empty()) return;
  ...
  Path64 ClipRect_::GetPath(OutPt2*& op)
  {
  ...
  Paths64 ClipRect_::Execute(const Paths64& paths, bool convex_only)
  {
    Paths64 result;
  ...
  Paths64 ClipRectLines_::Execute(const Paths64& paths)
  {
    Paths64 result;
    if (rect_.IsEmpty()) return result;
  ...
  void ClipRectLines_::ExecuteInternal(const Path64& path)
  {
  ...
  Path64 ClipRectLines_::GetPath(OutPt2*& op)
  {
    Path64 result;
