...
class DIALOG_COLOR_CONFIG_BASE : public DIALOG_SHIM
{
	...
	public:
		...
		DIALOG_COLOR_CONFIG_BASE( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("EESchema Colors"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 332,286 ), long style = wxDEFAULT_DIALOG_STYLE|wxRESIZE_BORDER ); 
