...
DIALOG_UPDATE_FROM_PCB::DIALOG_UPDATE_FROM_PCB_SAVED_STATE
        DIALOG_UPDATE_FROM_PCB::s_savedDialogState{ true, false, false, false, false };
...

{
    ...
    m_cbIgnoreStandalone->SetValue( s_savedDialogState.IgnoreStandaloneFootprints );
...
BACK_ANNOTATE::SETTINGS DIALOG_UPDATE_FROM_PCB::getSettings( bool aDryRun )
{
    return BACK_ANNOTATE::SETTINGS{ m_messagePanel->Reporter(), m_cbUpdateFootprints->GetValue(),
        ...
        m_cbIgnoreStandalone->GetValue(), m_cbIgnoreOtherProjects->GetValue(), aDryRun };
}
...
void DIALOG_UPDATE_FROM_PCB::OnOptionChanged( wxCommandEvent& event )
{
    ...
    s_savedDialogState.IgnoreStandaloneFootprints = m_cbIgnoreStandalone->GetValue();
