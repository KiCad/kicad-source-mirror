...
template <class T>
void SCH_TOOL_BASE<T>::Reset( RESET_REASON aReason )
{
...
template <class T>
bool SCH_TOOL_BASE<T>::IsSymbolEditor() const
{
...
template <class T>
int SCH_TOOL_BASE<T>::Increment( const TOOL_EVENT& aEvent )
{
...
template <class T>
int SCH_TOOL_BASE<T>::InteractiveDelete( const TOOL_EVENT& aEvent )
{
...
template <class T>
void SCH_TOOL_BASE<T>::saveCopyInUndoList( EDA_ITEM* aItem, UNDO_REDO aType, bool aAppend, bool aDirtyConnectivity )
{
    if( !aItem->IsSCH_ITEM() )
        return;
...
template class SCH_TOOL_BASE<SCH_BASE_FRAME>;
template class SCH_TOOL_BASE<SCH_EDIT_FRAME>;
template class SCH_TOOL_BASE<SYMBOL_EDIT_FRAME>;
