...
/**
 * @file  eeschema_action_plugins.h
 * @brief Python action plugin bridge for Eeschema
 */

#ifndef EESCHEMA_ACTION_PLUGINS_H
#define EESCHEMA_ACTION_PLUGINS_H
...
class PYTHON_SCH_ACTION_PLUGIN : public SCH_ACTION_PLUGIN
{
public:
    PYTHON_SCH_ACTION_PLUGIN( PyObject* action );
    ~PYTHON_SCH_ACTION_PLUGIN();
...
class PYTHON_SCH_ACTION_PLUGINS
{
public:
...
/**
 * Initialize the eeschema Python plugin environment.
 * Registers the _eeschema_action_plugins module and loads plugins.
 */
void InitEeschemaActionPlugins();

/**
 * Load (or reload) all eeschema action plugins from standard directories.
 */
void LoadEeschemaActionPlugins();


#endif /* EESCHEMA_ACTION_PLUGINS_H */
