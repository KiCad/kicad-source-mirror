...
LANGUAGE_DESCR LanguagesList[] =
{
    ...
    { wxLANGUAGE_FRENCH,     ID_LANGUAGE_FRENCH,     _( "French" ),     false },
    { wxLANGUAGE_SPANISH,    ID_LANGUAGE_SPANISH,    _( "Spanish" ),    false },
    { wxLANGUAGE_PORTUGUESE, ID_LANGUAGE_PORTUGUESE, _( "Portuguese" ), false },
    { wxLANGUAGE_ITALIAN,    ID_LANGUAGE_ITALIAN,    _( "Italian" ),    false },
    { wxLANGUAGE_GERMAN,     ID_LANGUAGE_GERMAN,     _( "German" ),     false },
    { wxLANGUAGE_GREEK,      ID_LANGUAGE_GREEK,      _( "Greek" ),      false },
    { wxLANGUAGE_HUNGARIAN,  ID_LANGUAGE_HUNGARIAN,  _( "Hungarian" ),  false },
    { wxLANGUAGE_POLISH,     ID_LANGUAGE_POLISH,     _( "Polish" ),     false },
    { wxLANGUAGE_CZECH,      ID_LANGUAGE_CZECH,      _( "Czech" ),      false },
    { wxLANGUAGE_RUSSIAN,    ID_LANGUAGE_RUSSIAN,    _( "Russian" ),    false },
    ...
    { wxLANGUAGE_CATALAN,    ID_LANGUAGE_CATALAN,    _( "Catalan" ),    false },
    { wxLANGUAGE_JAPANESE,   ID_LANGUAGE_JAPANESE,   _( "Japanese" ),   false },
    { wxLANGUAGE_LITHUANIAN, ID_LANGUAGE_LITHUANIAN, _( "Lithuanian" ), false },
    { 0, 0, "", false }         // Sentinel
};
#undef _
