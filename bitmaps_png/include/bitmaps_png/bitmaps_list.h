...
EXTERN_BITMAP( align_items_left_sm_xpm )
EXTERN_BITMAP( align_items_right_xpm )
EXTERN_BITMAP( align_items_right_sm_xpm )
EXTERN_BITMAP( align_items_top_xpm )
EXTERN_BITMAP( align_items_top_sm_xpm )
EXTERN_BITMAP( align_items_bottom_xpm )
EXTERN_BITMAP( align_items_bottom_sm_xpm )
...
EXTERN_BITMAP( font_bold_xpm )
EXTERN_BITMAP( font_bolditalic_xpm )
EXTERN_BITMAP( font_italic_xpm )
EXTERN_BITMAP( font_normal_xpm )
