...
public:
            ...
            m_settingsManager( true )
    {
        ...
        // Load an empty project so schematic operations work
    ...
    SETTINGS_MANAGER& GetSettingsManager() { return m_settingsManager; }
...
BOOST_AUTO_TEST_CASE( DerivedSymbolEmbeddedFiles )
{
    ...
    {
        SCHEMATIC schematic( &GetSettingsManager().Prj() );
