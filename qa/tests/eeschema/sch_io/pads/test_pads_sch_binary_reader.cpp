...
BOOST_AUTO_TEST_CASE( DetectsSupportedBinaryVersions )
{
    const std::vector<uint8_t> v12Header = {
        0x00, 0xFE, 0x0C, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    };
    const std::vector<uint8_t> v13Header = {
        0x00, 0xFE, 0x0D, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    };

    BOOST_CHECK( PADS_SCH_BINARY_READER::IsBinaryFamily( v12Header ) );
    BOOST_CHECK( PADS_SCH_BINARY_READER::IsBinaryFamily( v13Header ) );
