...
{
    BOOST_CHECK( IsAutoGeneratedNetName( "unconnected-(VD1A-A-Pad2)" ) );
    BOOST_CHECK( IsAutoGeneratedNetName( "Net-(VD1-Pad2)" ) );
    BOOST_CHECK( !IsAutoGeneratedNetName( "/Net-(A)/SIG" ) );
    BOOST_CHECK( !IsAutoGeneratedNetName( "MyNet-(U1-Pad2)" ) );
    BOOST_CHECK( !IsAutoGeneratedNetName( wxString() ) );
}
