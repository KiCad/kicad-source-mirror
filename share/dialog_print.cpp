...
////@begin WinEDA_PrintFrame event table entries
    ...
    EVT_SPINCTRL( ID_PEN_WIDTH, WinEDA_PrintFrame::OnPenWidthUpdated )
...
////@begin WinEDA_PrintFrame content construction
    // Generated by DialogBlocks, 13/01/2007 16:42:47 (unregistered)
    ...
    wxStaticText* itemStaticText13 = new wxStaticText( itemDialog1, wxID_STATIC, _("Pen width mini"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer12->Add(itemStaticText13, 0, wxGROW|wxLEFT|wxRIGHT|wxTOP|wxADJUST_MINSIZE, 5);

    m_ButtPenWidth = new wxSpinCtrl( itemDialog1, ID_PEN_WIDTH, _T("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 0 );
    itemBoxSizer12->Add(m_ButtPenWidth, 0, wxGROW|wxALL, 5);
    ...
    itemBoxSizer12->Add(itemStaticBoxSizer15, 0, wxGROW|wxALL, 5);
    ...
    itemStaticBoxSizer15->Add(m_Print_Sheet_Ref, 0, wxGROW|wxALL, 5);
    ...
    itemStaticBoxSizer15->Add(m_Print_Mirror, 0, wxGROW|wxALL, 5);
    ...
    itemBoxSizer2->Add(itemBoxSizer22, 0, wxALIGN_TOP|wxALL, 5);

    itemBoxSizer22->Add(5, 5, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);

    wxButton* itemButton24 = new wxButton( itemDialog1, ID_PRINT_SETUP, _("Print S&etup"), wxDefaultPosition, wxDefaultSize, 0 );
    itemButton24->SetForegroundColour(wxColour(121, 118, 0));
    itemBoxSizer22->Add(itemButton24, 0, wxGROW|wxALL, 5);

    wxButton* itemButton25 = new wxButton( itemDialog1, ID_PRINT_PREVIEW, _("Pre&view"), wxDefaultPosition, wxDefaultSize, 0 );
    itemButton25->SetForegroundColour(wxColour(0, 0, 196));
    itemBoxSizer22->Add(itemButton25, 0, wxGROW|wxALL, 5);

    wxButton* itemButton26 = new wxButton( itemDialog1, ID_PRINT_EXECUTE, _("&Print"), wxDefaultPosition, wxDefaultSize, 0 );
    itemButton26->SetForegroundColour(wxColour(0, 128, 64));
    itemBoxSizer22->Add(itemButton26, 0, wxGROW|wxALL, 5);

    wxButton* itemButton27 = new wxButton( itemDialog1, wxID_CLOSE, _("&Close"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer22->Add(itemButton27, 0, wxGROW|wxALL, 5);
...
void WinEDA_PrintFrame::OnPenWidthUpdated( wxSpinEvent& event )
{
	SetPenWidth(event);
}
